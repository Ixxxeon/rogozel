...
import j4x4.domain.Location;
import j4x4.repository.LocationRepository;
import j4x4.service.LocationService;
...
public class LocationResourceIT {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getHouse()).isEqualTo(DEFAULT_HOUSE);
        assertThat(testLocation.getFlat()).isEqualTo(DEFAULT_FLAT);
    }
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getHouse()).isEqualTo(UPDATED_HOUSE);
        assertThat(testLocation.getFlat()).isEqualTo(UPDATED_FLAT);
    }
